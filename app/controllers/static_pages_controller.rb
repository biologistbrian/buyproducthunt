class StaticPagesController < ApplicationController
  ...
  def booger
    ...
    rit = HTTP.auth('Bearer '+@b['access_token']).post('https://api.producthunt.com/v2/api/graphql', :json => { 'query':'{viewer(){user{id, name, username,isMaker,twitterUsername,coverImage}}}'})
